...
> Source file: `Performance Evaluation of SDN-Enabled Switching System For IoT Infrastructure.pdf`
...
entri ini, sakelar ini dapat meneruskan lalu lintas. Sakelar
| OpenFlow  | karena  |     | itu  | bergantung  |     | pada  | konfigurasi  |     |     |     |
| --------- | ------- | --- | ---- | ----------- | --- | ----- | ------------ | --- | --- | --- |
...
perangkat lunak yang dapat berjalan di Raspberry Pi,
...
lain. Pada dasarnya ini adalah jaringannya sendiri. Namun, ia
juga harus dapat berkomunikasi dengan jaringan lain seperti
Jaringan 1 di mana host berada. Sebuah komputer ditunjuk
sebagai titik pusat LAN ini. Komputer ini bertindak sebagai
server, mendengarkan node host Jaringan 1 dan merespons
paket.
...
| --------- | ---------- | ------------- | ------------ | --- | --------------- | --- | --- | --- | --- | --- |
juga dikonfigurasi dengan alamat IP statis dan terhubung ke
Port Ethernet kedua Raspberry Pi. Raspberry Pi berfungsi
...
Gbr. 12.  Total throughput vs jumlah node
Ditentukan Perangkat Lunak, NFV-SDN 2015. Konferensi IEEE 2015
...
| --- | --- | --- | --- | --- | --- | --- | ---------------------------------------------------------------- | --- | --- | --- | --- | --- | --- |
berdasarkan  jumlah  klien  untuk  paket  UDP.  Iperf  perangkat  keras  dan  perangkat  lunak  dari  QoS  yang  dapat
dikonfigurasi untuk streaming video berdasarkan protokol OpenFlow
memberikan kita kemampuan untuk meniru jumlah klien  dan platform NetFPGA. Multimedia Tools and Applications, 77(7),
| serta paket UDP dengan menggabungkan parameter tertentu.  |     |     |     |     |     |     | 9071-9091.                                                            |     |     |     |     |     |     |
| --------------------------------------------------------- | --- | --- | --- | --- | --- | --- | --------------------------------------------------------------------- | --- | --- | --- | --- | --- | --- |
|                                                           |     |     |     |     |     |     | [6] Huang, H., Zhu, J., & Zhang, L. (2014). Kerangka kerja manajemen  |     |     |     |     |     |     |
Packet loss bertujuan untuk mengetahui berapa persen paket  berbasis SDN untuk perangkat IoT. Dalam Publikasi Konferensi IET
(Vol. 2014). https://doi.org/10.1049/cp.2014.0680
yang hilang karena keterbatasan perangkat keras atau sistem.
...
| --- | --- | --- | --- | --- | --- | --- | ---------------------------------------------------------------------- | --- | --- | --- | --- | --- | --- |
Internet of things (IoT) berbasis jaringan yang ditentukan perangkat
Gbr. 13. Rasio kehilangan paket vs. jumlah node
lunak (SDN): Sebuah jalan di depan. ACM International Conference
|     |     |     |     |     |     |     | Proceeding  |     | Series,  |     | Part  |     | F130522.  |
| --- | --- | --- | --- | --- | --- | --- | ----------- | --- | -------- | --- | ----- | --- | --------- |
Pada gambar 13 di atas, dapat dijelaskan bahwa untuk  https://doi.org/10.1145/3102304.3102319
hasil  pengujian  packet  loss  telah  didapatkan  hasil  untuk  [12] Yang, Y. Y., Yang, C. T., Chen, S. T., Cheng, W. H., & Jiang, F. C.
(2015). Implementasi sistem pemantau lalu lintas jaringan dengan
pengaksesan jumlah Node mulai dari 3 hingga 96 node.  SDN. Prosiding - Konferensi Perangkat Lunak dan Aplikasi Komputer
Pada pengujian dengan 3 node yang melakukan request ke  Internasional, 3, 631-634.
|     |     |     |     |     |     |     | [13] H. Kim, J. Kim dan Y. Ko, "Mengembangkan testbed OpenFlow yang  |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | -------------------------------------------------------------------- | --- | --- | --- | --- | --- | --- |
server, node mendapatkan rata-rata packet loss sebesar 0%,  hemat  biaya  untuk  Software  Defined  Networking  skala  kecil,"
|     |     |     |     |     |     |     |     |     |     |     | .-L.  Tseng  | dan  | F.  J.  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ------------ | ---- | ------- |
yang artinya semua data dapat terkirim 100%. 16thInternational Conference on [14]
Lin,"Memperluas
|     |     |     |     |     |     |     |     |     | skalabilitas  | platform  | IoT  | /  M2M  | dengan  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | ------------- | --------- | ---- | ------- | ------- |
...
| --- | --- | --- | --- | --- | --- | --- | -------------------------------------------------------------------- | --- | --- | --- | --- | --- | --- |
sebuah  metode  pengukuran  aktif,  yang  sangat  umum  di  untuk aliran data menggunakan papan Raspberry Pi di jaringan yang
|           |                |           |     |        |                |     | ditentukan  | oleh  | perangkat  | lunak,"  | 2017  IEEE       | 8th  | International  |
| --------- | -------------- | --------- | --- | ------ | -------------- | --- | ----------- | ----- | ---------- | -------- | ---------------- | ---- | -------------- |
| kalangan  | administrator  | jaringan  |     | untuk  | membandingkan  |     |             |       |            |          |                  |      |                |
|           |                |           |     |        |                |     | Conference  | on    | Awareness  | Science  | and  Technology  |      | (iCAST),       |
Taichung, 2017, hlm. 330-333.
jaringan mereka. Setiap kasus pengujian memiliki kriteria
|     |     |     |     |     |     |     | [16] M. Priyadarsini, P. Bera dan R. Bampal, "Analisis kinerja arsitektur  |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | -------------------------------------------------------------------------- | --- | --- | --- | --- | --- | --- |
pengujian yang berbeda dan parameter QoS yang berbeda
pengendali jaringan yang didefinisikan perangkat lunak-sebuah survei
dievaluasi. Hasil pengujian dijelaskan secara rinci dalam  berbasis simulasi," Konferensi Internasional Komunikasi Nirkabel,
Pemrosesan Sinyal, dan Jaringan (WiSPNET) 2017, Chennai, 2017,
bentuk tabel dan grafik. Tabel digunakan untuk keakuratan
pp. 1929-1935.
hasil  dan  grafik  digunakan  untuk  tujuan  visualisasi.  [17] C. Fancy dan M. Pushpalatha, "Evaluasi kinerja pengendali SDN POX
|     |     |     |     |     |     |     | dan  lampu  | sorot  | di  lingkungan  |     | emulasi  mininet,"  |     | Konferensi  |
| --- | --- | --- | --- | --- | --- | --- | ----------- | ------ | --------------- | --- | ------------------- | --- | ----------- |
Hasilnya,  keseluruhan  persyaratan  aplikasi  Internet  untuk  Internasional tentang Sistem Berkelanjutan Cerdas (ICISS) 2017,
parameter QoS diidentifikasi untuk memvalidasi hasil dari  Palladam, 2017, hlm. 695-699.
|     |     |     |     |     |     |     | [18] R. G. Barba, M. Criollo, N. Aimacaña, C. Manosalvas dan C. Silva-  |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | ----------------------------------------------------------------------- | --- | --- | --- | --- | --- | --- |
Raspberry  Pi  yang  bersangkutan.  Software  Defined  Cardenas, "Kebijakan QoS untuk Meningkatkan Performa di Kampus
|     |     |     |     |     |     |     | Akademik  | dan  Jaringan  | SDN,"  | Konferensi  | Komunikasi  |     | Amerika  |
| --- | --- | --- | --- | --- | --- | --- | --------- | -------------- | ------ | ----------- | ----------- | --- | -------- |
Networking adalah bidang penelitian yang sangat menarik
Latin IEEE ke-10 (LATINCOM) 2018, Guadalajara, 2018, hlm. 1-6.
| dengan  kemungkinan  |     | tak  | terbatas.  | Penggabungan  |     | IoT  |                                                                     |     |     |     |     |     |     |
| -------------------- | --- | ---- | ---------- | ------------- | --- | ---- | ------------------------------------------------------------------- | --- | --- | --- | --- | --- | --- |
|                      |     |      |            |               |     |      | [19] S. Han dan S. Lee, "Mengimplementasikan SDN dan jaringan yang  |     |     |     |     |     |     |
dapat diprogram berbasis jaringan-hypervisor menggunakan Pi stack
| dengan  bidang  | penelitian  |     | yang  | begitu  | kuat  | dapat  |     |     |     |     |     |     |     |
| --------------- | ----------- | --- | ----- | ------- | ----- | ------ | --- | --- | --- | --- | --- | --- | --- |
switch," Konferensi Internasional Konvergensi Teknologi Informasi
menghasilkan  inovasi  yang  signifikan  terhadap  hal-hal  dan Komunikasi 2015 (ICTC), Jeju, 2015, hlm. 579-581.
sehari-hari  yang  sudah  tersedia.  Sistem  saat  ini  hanya  [20] A. Malishevskiy, D. Gurkan, L. Dane, R. Narisetty, S. Narayan dan S.
Bailey, "Manajemen Jaringan Berbasis OpenFlow dengan Visualisasi
menggunakan Open vSwitch
